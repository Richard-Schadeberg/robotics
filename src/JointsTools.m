classdef JointsTools < handle
    ...
    methods
        function joint_velocities = get_joint_velocities(weighted_matrix, jacobian_matrix, end_effector_velocities)
            joint_velocities = inv(weighted_matrix) * jacobian_matrix' * (inv(jacobian_matrix * inv(weighted_matrix) * jacobian_matrix') * end_effector_velocities
